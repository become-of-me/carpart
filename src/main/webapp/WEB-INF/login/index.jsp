...
<form id="uploadForm" enctype="multipart/form-data">
        <input id="file" type="file" name="file" class="in"/>
        <br><br><br>
        <button id="upload" type="button" class="in"  onclick="uploadImg()" >点击上传</button>
...
<script>
    ...
    function update(obj) {
        var pictureid=$("#tupianming").val();
        var companyid=$("#companyid").val();
        $.ajax({

            type : "post",
            url : "${ctx}/upLoad/updateCompany",
            data : {
                'pictureid' : pictureid,
                'data' : obj,
                'companyid': companyid
...
<div style="float: left;">
           
        </div>
        <input type="hidden" id="tupianming" value="${pictureid}"/>
